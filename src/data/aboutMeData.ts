    ...
    ru: {
        ...
        workExperience: {
            frontEnd: {
                ...
                desc2Work: 'Архитектура проекта, включая UI, BLL, DAL',
                ...
                title: 'Мои проекты:',
                projectWbNotice: 'Уведомления в Telegram о изменении цены на Wildberries',
                projectOnlineShop: 'Прототип онлайн магазина',
                projectCards: 'Обучающие карточки',
                projectSocialNetwork: ' Социальная сеть',
                projectTodolist: 'Список дел',
                projectRestaurant: 'Приложение для ресторана',
                projectElektronika24: 'Электроника24',
    ...
    en: {
        ...
        workExperience: {
            frontEnd: {
                ...
                desc2Work: 'Architecture of project, including UI, BLL, DAL',
                ...
                title: 'My projects:',
                projectWbNotice: 'Telegram notifications about price changes on Wildberries',
                projectOnlineShop: 'Prototype online store',
                projectCards: 'Learning Cards',
                projectSocialNetwork: 'Social Network',
                projectTodolist: 'Todolist',
                projectRestaurant: 'Restaurant app',
                projectElektronika24: 'Elektronika24',
